...
export default function Home() {
  ...
  useEffect(() => {
    // التحقق من نجاح الـ Form من الرابط (الحل الجذري لـ iOS)
  ...
  return (
    <div dir="rtl" className="min-h-screen bg-white font-sans">
          ...
          <div id="join-form" className="bg-white border border-gray-200 rounded-2xl p-8 shadow-xl relative z-10">
            {success ? (
              ...
              <>
                ...
                {/* ✅ الحل الجذري مدمج مع نفس تصميمك بالضبط */}
      ...
      {/* ✅ قسم المنتجات بتصميمه الأصلي مع زر المشاهدة الكل */}
      ...
      {/* ✅ قسم الموردين بتصميمه الأصلي كامل */}
      ...
      {/* ✅ قسم الاستيراد بتصميمه الأصلي كامل */}
